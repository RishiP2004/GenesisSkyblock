...
class ScoreFactory {
	 ...
	 *
	 * This will remove the previous score lines without removing them from islandCache
	 ...
	 * Note: Do check for if the player has islandCache via ScoreFactory::hasCache() beforehand!
	 */
	...
	/**
	 * Remove the players islandCache.
	 */
